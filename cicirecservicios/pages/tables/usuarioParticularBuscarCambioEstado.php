...
<html>
  ...
  <aside class="main-sidebar">
    ...
    <!-- /.sidebar -->
      ...
      <h1>
        Información usuario <?php echo $usuario;?> para cambio de estado facturación
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <?php 
                    if($estadopago != 'Aprobada'){
                  ?>
                    <a href="actualizarEstadoFacturacion.php?id_auto=<?php echo $row['id'];?>&criterio=<?php echo $usuario;?>" class="btn-upload btn btn-danger" title="Sin atender!" role="button"><i class="fa fa-times" aria-hidden="true"></i></a>
                  <?php
                  }else{
                  ?>
