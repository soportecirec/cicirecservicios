...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <section class="content-header">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h5 id="texto-cambiar-color" style="margin: -2px 0px 10px 5px">
              <?php
          ...
          ' y entidad: '. $entidad;*/
              ...
              $mensaje = "Hola, le escribimos de la Fundacion Cirec";
 ...
 <!-- PHP PARA TRAER DATOS ASISTENCIALES -->
 <?php

$buscarInfoAsistencial = "SELECT * FROM informacionasistencial WHERE autorizacion = '$autorizacion' and documento = '$documento'";
...
$grupo = $rowinfoAsistencial['grupo'];
$intensidadsemana = $rowinfoAsistencial['intensidadsemana'];
$min = $rowinfoAsistencial['min'];
$dxcodigo = $rowinfoAsistencial['dxcodigo'];
$ciclo = $rowinfoAsistencial['ciclo'];
$mesactual = $rowinfoAsistencial['mesactual'];
$mes = $rowinfoAsistencial['mes'];
$frecuencia = $rowinfoAsistencial['frecuencia'];
$tiempo = $rowinfoAsistencial['tiempo'];
$diagnostico = $rowinfoAsistencial['diagnostico'];
$id_otraespecialidad = $rowinfoAsistencial['id_otraespecialidad'];
...
?>
              ...
              <div class="row">
                <div class="col-xs-6 col-sm-4">
                  ...
                  Autorización Nro. <strong><?php echo $autorizacion; ?></strong><br>
                  Telefono: <strong><?php echo $telefono; ?> <a href="<?php echo $enlace_whatsapp; ?>" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/1197px-WhatsApp.svg.png" alt="WhatsApp" width="20px"></a></strong><br>
            ...
            <div class="panel-footer">
                  ...
                  <div class="panel-heading" role="tab" id="headingOne">
                    <h4 class="panel-title">
                      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        Mostrar información asistencial <i class="fa fa-arrow-down"></i>
                      </a>
                    </h4>
                  </div>
                  <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                      <!-- INICIO INFORMACIÓN ASISTENCIAL -->
                      <div class="row">
                        <div class="col-xs-6 col-sm-6">
                          <p><strong>Grupo:</strong> <?php echo $grupo; ?></p>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                          <p><strong>Frecuencia:</strong> <?php echo $frecuencia; ?></p>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                          <p><strong>Tiempo:</strong> <?php echo $tiempo; ?></p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-6 col-sm-6">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <p><strong>Mes:</strong> <?php echo $mes  ?></p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-6 col-sm-2">
                          <p><strong>Mes actual:</strong> <?php echo $mesactual  ?></p>
                        </div>
                      </div>
                      <!-- FIN INFORMACIÓN ASISTENCIAL -->
                    </div>
                  </div>
                </div>
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                      <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        Mostrar información de facturación <i class="fa fa-arrow-down"></i>
                      </a>
                    </h4>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 text-right">
                  ...
                  <?php
                  if ($perfil == 'terapeutaval' || $perfil == 'gestorseguimiento') {
                  ?>
                    <?php include('modalInformacionAsistencial.php'); ?>
                    <a href="#editInfoAsistencial_<?php echo $id; ?>" class="btn btn-warning btn-sm" data-toggle="modal">
                      <span class="glyphicon glyphicon-edit"></span>&ensp;<span style="font-size: 14px;">Editar Info Asistencial</span>
                    </a>
                  <?php
                  }
                  ?>
