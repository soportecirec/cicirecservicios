        ...
        <div class="panel panel-default">
          ...
          //Obtener datos en mayuscula entidad
            ...
            <div class="panel-footer">
              ...
              <p><strong>Valor Servicio:</strong> <?php echo $tarifaDefinida; ?></p>
              <p><strong>Cuota Moderadora:</strong> <?php echo $cuotamoderadora; ?></p>
              <p><strong>Valor Copago:</strong> <?php echo $copago; ?></p>

              <?php
              //operacion matematica valor real servicio           

              $valorreal = $tarifaDefinida - $cuotamoderadora - $copago;
...
<?php
          ...
          <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Facturación</span>
                <span class="info-box-number">$<?php echo $valorreal; ?></span>
              </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
          </div><!-- /.col -->
          <?php
