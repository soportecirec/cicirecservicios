          ...
          //Obtener datos en mayuscula entidad
            ...
            <div class="panel-footer">
              ...
              <div class="row">
                  ...
                  <div class="col-xs-6 col-sm-3">
                      <p><strong>Valor Servicio:</strong> $<?php echo number_format($tarifaDefinida, 0, ',', '.'); ?></p>
                  </div>
                  <div class="col-xs-6 col-sm-3">
              ...
              <div class="row">
                  ...
                  <div class="col-xs-6 col-sm-3">
                      ...
                      ?>
                      <p><strong>Valor Real Servicio:</strong> $<?php echo number_format($valorreal, 0, ',', '.');; ?></p>
                  </div>
              </div>
              <div class="row">
...
<?php
          ...
          <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Facturación</span>
                <span class="info-box-number">$<?php echo number_format($valorreal, 0, ',', '.');; ?></span>
              </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
          </div><!-- /.col -->
          <?php
