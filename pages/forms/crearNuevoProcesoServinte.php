              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" id="fupForm" action="crearNuevoProceso.php" method="POST" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <!-- VALIDAR SI EL TELEFONO VIENE VACÍO -->
                    <?php
                    if($telefono == ""){
                    ?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="telefono_usuario" name="telefono" placeholder="" value="<?php echo $telefono; ?>" required>
                      </div>
                    </div>
                    <?php }//cierra if 
                    else{
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="telefono_usuario" name="telefono" placeholder="" value="<?php echo $telefono; ?>" required readonly>
                      </div>
                    </div>
                    <?php }//cierra else ?>
